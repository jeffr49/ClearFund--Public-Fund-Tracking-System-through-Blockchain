...
export default function DedicatedGatePage() {
  ...
  return (
    <div className="gate-screen" style={{
      minHeight: "100vh",
      ...
      <div className="gate-card" style={{
        ...
        <div className="logo" style={{ fontSize: "2rem", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "2rem", color: "var(--accent-primary)", fontWeight: "800" }}>
        ...
        <div className="gate-icon" style={{
          ...
          <i className={`fa-solid ${role === "contractor" ? "fa-helmet-safety" : role === "government" ? "fa-building-columns" : "fa-user-shield"}`}></i>
        </div>
        ...
        <p style={{ color: "var(--text-secondary)", marginBottom: "2.5rem", lineHeight: "1.6" }}>
          Welcome back, {user?.name || "Official"}.<br />
          Please verify your MetaMask identity to access the <strong>{(role || "public").toUpperCase()}</strong> workspace.
        </p>
